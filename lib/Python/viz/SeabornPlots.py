...
if __name__ == '__main__':
    ...
    df_cd = returnQmodOnly("CALIBRATION.db")
    obs = returnObsOnly("CALIBRATION.db")

    ax = sns.lineplot(x="time", y="qMod", data=df_cd)
    ...
    ax = sns.lineplot(x='time', y='qObs', data=obs, color='black', linestyle='dashed', label='BR TWIN SPRINGS')
    plt.legend()
